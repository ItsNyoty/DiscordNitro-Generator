...
class NitroGen: 
    ...
    def main(self): 
        ...
        if os.name == "nt": 
            print("")
            ctypes.windll.kernel32.SetConsoleTitleW("Nitro Generator and Checker - Made by YopE#2343") 
        else: 
            print(f'\33]0;Nitro Generator and Checker - Made by YopE#2343\a', end='', flush=True) 
...
|_  $$_/| $$             | $$$ | $$                      | $$              
  ...
  | $$  | $$ /$$\____  $$| $$\  $$$| $$  | $$| $$  | $$  | $$ /$$| $$  | $$
 /$$$$$$|  $$$$//$$$$$$$/| $$ \  $$|  $$$$$$$|  $$$$$$/  |  $$$$/|  $$$$$$$
|______/ \___/ |_______/ |__/  \__/ \____  $$ \______/    \___/   \____  $$
                                    /$$  | $$                     /$$  | $$
                                   |  $$$$$$/                    |  $$$$$$/
                                    \______/                      \______/
 """) 
        time.sleep(2) 
        self.slowType("Made by: Nissan Qashqai 1.4L#9476", .02)
        time.sleep(1) 
        ...
        url = input('') 
        webhook = url if url != "WEBHOOK HERE" else None # If the url is empty make it be None insted
        ...
        for i in range(num): 
            ...
            if os.name == "nt": # 
                ctypes.windll.kernel32.SetConsoleTitleW(f"Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by Nissan Qashqai 1.4L#9476") 
                print("")
            else:
                print(f'\33]0;Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by YopE#2343\a', end='', flush=True) 
        print(f"""
Results:
 Valid: {len(valid)}
 Invalid: {invalid}
